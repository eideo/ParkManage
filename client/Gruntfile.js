...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      livereload: {
        files: [
          '{.tmp,<%= yeoman.client %>}/{components,app}/**/*.css',
          '{.tmp,<%= yeoman.client %>}/{components,app}/**/*.html',
        ...
        options: {
          ...
          callback: function(nodemon) {
            ...
            nodemon.on('config:update', function() {
              setTimeout(function() {
                require('open')('http://localhost:9000/debug?port=5856');
              }, 500);
            });
          }
        }
    ...
    injector: {
        ...
        files: {
          '<%= yeoman.client %>/index.html': [
            [
              ...
              '{.tmp,<%= yeoman.client %>}/app/**/index.js'],
      ...
      css: {
        ...
        files: {
          '<%= yeoman.client %>/index.html': [
            '<%= yeoman.client %>/{app,css,components}/**/*.css'
          ]
        }
      }
    }
